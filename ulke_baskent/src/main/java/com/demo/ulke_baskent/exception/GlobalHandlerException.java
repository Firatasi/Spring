...
public class GlobalHandlerException {
    ...
    public ResponseEntity<Map<String,Object>> handleAlreadyExistException(UserNotFoundException ex, ServletWebRequest webRequest) {
        HashMap<String,Object> map  =  new HashMap<>();
        map.put("message", ex.getMessage());
    ...
    public ResponseEntity<Map<String,Object>> handleUserNotFoundException(UserNotFoundException ex, ServletWebRequest webRequest) {
        HashMap<String,Object> map  =  new HashMap<>();
        map.put("message", ex.getMessage());
